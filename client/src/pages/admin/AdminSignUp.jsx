            ...
            <div className='flex p-3 max-w-3xl mx-auto flex-col md:flex-row md:items-center gap-5'>
                ...
                <div className='flex-1'>
                    ...
                    <p className='text-sm mt-5'>
                        Ready to manage the platform? Register now and start managing users, content, and more!!
                    </p>
                </div>
                {/* right */}
                <div className='flex-1'>
                <h2 className='text-2xl font-bold mb-5'>Register as Admin</h2> 
                    ...
                    <div className='flex gap-2 text-sm mt-5'>
                        ...
                        <Link to='/admin/sign-in' className='text-blue-500'>
                            Sign In
                        </Link>
                    </div>
                    {errorMessage && (
