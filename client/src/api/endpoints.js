...
const endpoints = {
    ...
    STUDENT_SIGNOUT:'/student/signout',
    STUDENT_GOOGLE_SIGNIN:'/student/google-signin',
   ...
   TUTOR_SIGN_UP: '/tutor/signup',
    ...
    TUTOR_SIGNOUT:'/tutor/signout',
    TUTOR_GOOGLE_SIGNIN:'/tutor/google-signin',
   ...
   ADMIN_GET_OTP_VERIFICATION:'/admin/otp-verification',
    ...
    ADMIN_GOOGLE_SIGNIN:'/admin/google-signin',
